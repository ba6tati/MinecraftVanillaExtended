package bg.bashtati.vanilla_extended.block;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, VanillaExtended.MODID);

    public static final RegistryObject<Block> LOCUST_BLOCK = registerBlock("locust_block",
